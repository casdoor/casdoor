...
func initAPI() {
	...
	beego.Router("/api/login/oauth/code", &controllers.ApiController{}, "*:GetOAuthCode")
	beego.Router("/api/login/oauth/access_token", &controllers.ApiController{}, "*:GetOAuthToken")
	beego.Router("/api/login/oauth/refresh_token", &controllers.ApiController{}, "*:RefreshToken")
	beego.Router("/api/login/oauth/introspect", &controllers.ApiController{}, "*:IntrospectToken")
	beego.Router("/api/login/oauth/logout", &controllers.ApiController{}, "*:TokenLogout")
