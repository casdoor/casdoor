...
func initAPI() {
	...
	beego.Router("/api/get-emailAndPhone", &controllers.ApiController{}, "POST:GetEmailAndPhoneByUsername")
	beego.Router("/api/get-verifyEmailOrPhoneToken", &controllers.ApiController{}, "POST:VerifyEmailOrPhone")
	beego.Router("/api/forget-password", &controllers.ApiController{}, "POST:ForgetPassword")
