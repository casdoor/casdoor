...
func initAPI() {
	...
	beego.Router("/.well-known/:owner/:application/openid-configuration", &controllers.RootController{}, "GET:GetOidcDiscoveryByApplication")
	beego.Router("/.well-known/jwks", &controllers.RootController{}, "*:GetJwks")
	beego.Router("/.well-known/:owner/:application/jwks", &controllers.RootController{}, "*:GetJwksByApplication")
	beego.Router("/.well-known/webfinger", &controllers.RootController{}, "GET:GetWebFinger")
	beego.Router("/.well-known/:owner/:application/webfinger", &controllers.RootController{}, "GET:GetWebFingerByApplication")
