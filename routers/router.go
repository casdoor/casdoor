...
func InitAPI() {
	...
	web.Router("/api/impersonation-user", &controllers.ApiController{}, "POST:ImpersonateUser")
	web.Router("/api/exit-impersonation-user", &controllers.ApiController{}, "POST:ExitImpersonateUser")
