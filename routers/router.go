...
func InitAPI() {
	...
	web.Router("/api/get-dashboard-users-by-provider", &controllers.ApiController{}, "GET:GetDashboardUsersByProvider")
	web.Router("/api/get-dashboard-resources-by-provider", &controllers.ApiController{}, "GET:GetDashboardResourcesByProvider")
