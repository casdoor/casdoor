...
import {boolColumn, dateColumn, linkColumn, tagsColumn, textColumn} from "@/components/crud/columns";
...
export default function WebhookListPage() {
  ...
  const columns: ColumnDef<any>[] = [
    ...
    textColumn({dataIndex: "contentType", title: i18next.t("webhook:Content type"), width: 150}),
    tagsColumn({dataIndex: "events", title: i18next.t("webhook:Events"), width: 220}),
