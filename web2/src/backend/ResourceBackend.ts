...
export function getResources(owner, user, page: any = "", pageSize: any = "", field: any = "", value: any = "", sortField: any = "", sortOrder: any = "") {
...
export function deleteResource(resource, provider: any = "") {
  const newResource = Setting.deepCopy(resource);
...
export function uploadResource(owner, user, tag, parent, fullFilePath, file, provider: any = "") {
