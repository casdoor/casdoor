...
export function getEnforcers(owner, page: any = "", pageSize: any = "", field: any = "", value: any = "", sortField: any = "", sortOrder: any = "") {
...
export function getEnforcer(owner, name, loadModelCfg: any = false) {
