...
export function getSyncers(owner, organization, page: any = "", pageSize: any = "", field: any = "", value: any = "", sortField: any = "", sortOrder: any = "") {
...
export function getSyncer(owner, name, organization: any = owner) {
