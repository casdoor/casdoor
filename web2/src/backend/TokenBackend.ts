...
export function getTokens(owner, organization: any = "", page: any = "", pageSize: any = "", field: any = "", value: any = "", sortField: any = "", sortOrder: any = "") {
...
export function getToken(owner, name, organization: any = owner) {
