...
type User struct {
	...
	GitHub          string `xorm:"github text" json:"github"`
	Google          string `xorm:"google text" json:"google"`
	QQ              string `xorm:"qq text" json:"qq"`
	WeChat          string `xorm:"wechat text" json:"wechat"`
	Facebook        string `xorm:"facebook text" json:"facebook"`
	DingTalk        string `xorm:"dingtalk text" json:"dingtalk"`
	Weibo           string `xorm:"weibo text" json:"weibo"`
	Gitee           string `xorm:"gitee text" json:"gitee"`
	LinkedIn        string `xorm:"linkedin text" json:"linkedin"`
	Wecom           string `xorm:"wecom text" json:"wecom"`
	Lark            string `xorm:"lark text" json:"lark"`
	Gitlab          string `xorm:"gitlab text" json:"gitlab"`
	Adfs            string `xorm:"adfs text" json:"adfs"`
	Baidu           string `xorm:"baidu text" json:"baidu"`
	Alipay          string `xorm:"alipay text" json:"alipay"`
	Casdoor         string `xorm:"casdoor text" json:"casdoor"`
	Infoflow        string `xorm:"infoflow text" json:"infoflow"`
	Apple           string `xorm:"apple text" json:"apple"`
	AzureAD         string `xorm:"azuread text" json:"azuread"`
	AzureADB2c      string `xorm:"azureadb2c text" json:"azureadb2c"`
	Slack           string `xorm:"slack text" json:"slack"`
	Steam           string `xorm:"steam text" json:"steam"`
	Bilibili        string `xorm:"bilibili text" json:"bilibili"`
	Okta            string `xorm:"okta text" json:"okta"`
	Douyin          string `xorm:"douyin text" json:"douyin"`
	Kwai            string `xorm:"kwai text" json:"kwai"`
	Line            string `xorm:"line text" json:"line"`
	Amazon          string `xorm:"amazon text" json:"amazon"`
	Auth0           string `xorm:"auth0 text" json:"auth0"`
	BattleNet       string `xorm:"battlenet text" json:"battlenet"`
	Bitbucket       string `xorm:"bitbucket text" json:"bitbucket"`
	Box             string `xorm:"box text" json:"box"`
	CloudFoundry    string `xorm:"cloudfoundry text" json:"cloudfoundry"`
	Dailymotion     string `xorm:"dailymotion text" json:"dailymotion"`
	Deezer          string `xorm:"deezer text" json:"deezer"`
	DigitalOcean    string `xorm:"digitalocean text" json:"digitalocean"`
	Discord         string `xorm:"discord text" json:"discord"`
	Dropbox         string `xorm:"dropbox text" json:"dropbox"`
	EveOnline       string `xorm:"eveonline text" json:"eveonline"`
	Fitbit          string `xorm:"fitbit text" json:"fitbit"`
	Gitea           string `xorm:"gitea text" json:"gitea"`
	Heroku          string `xorm:"heroku text" json:"heroku"`
	InfluxCloud     string `xorm:"influxcloud text" json:"influxcloud"`
	Instagram       string `xorm:"instagram text" json:"instagram"`
	Intercom        string `xorm:"intercom text" json:"intercom"`
	Kakao           string `xorm:"kakao text" json:"kakao"`
	Lastfm          string `xorm:"lastfm text" json:"lastfm"`
	Mailru          string `xorm:"mailru text" json:"mailru"`
	Meetup          string `xorm:"meetup text" json:"meetup"`
	MicrosoftOnline string `xorm:"microsoftonline text" json:"microsoftonline"`
	Naver           string `xorm:"naver text" json:"naver"`
	Nextcloud       string `xorm:"nextcloud text" json:"nextcloud"`
	OneDrive        string `xorm:"onedrive text" json:"onedrive"`
	Oura            string `xorm:"oura text" json:"oura"`
	Patreon         string `xorm:"patreon text" json:"patreon"`
	Paypal          string `xorm:"paypal text" json:"paypal"`
	SalesForce      string `xorm:"salesforce text" json:"salesforce"`
	Shopify         string `xorm:"shopify text" json:"shopify"`
	Soundcloud      string `xorm:"soundcloud text" json:"soundcloud"`
	Spotify         string `xorm:"spotify text" json:"spotify"`
	Strava          string `xorm:"strava text" json:"strava"`
	Stripe          string `xorm:"stripe text" json:"stripe"`
	TikTok          string `xorm:"tiktok text" json:"tiktok"`
	Tumblr          string `xorm:"tumblr text" json:"tumblr"`
	Twitch          string `xorm:"twitch text" json:"twitch"`
	Twitter         string `xorm:"twitter text" json:"twitter"`
	Typetalk        string `xorm:"typetalk text" json:"typetalk"`
	Uber            string `xorm:"uber text" json:"uber"`
	VK              string `xorm:"vk text" json:"vk"`
	Wepay           string `xorm:"wepay text" json:"wepay"`
	Xero            string `xorm:"xero text" json:"xero"`
	Yahoo           string `xorm:"yahoo text" json:"yahoo"`
	Yammer          string `xorm:"yammer text" json:"yammer"`
	Yandex          string `xorm:"yandex text" json:"yandex"`
	Zoom            string `xorm:"zoom text" json:"zoom"`
	MetaMask        string `xorm:"metamask text" json:"metamask"`
	Web3Onboard     string `xorm:"web3onboard text" json:"web3onboard"`
	Custom          string `xorm:"custom text" json:"custom"`
	...
	Ldap       string            `xorm:"ldap text" json:"ldap"`
