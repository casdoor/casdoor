  ...
  renderTable(records) {
    ...
    return (
      <div>
        ...
        >
          <Descriptions bordered size="small" column={1} style={{padding: "12px", height: "100%", overflowY: "auto"}}>
            ...
            <Descriptions.Item label={i18next.t("record:Object")}>
              <CodeMirror
                value={this.getDetailField("object") ? JSON.stringify(JSON.parse(this.getDetailField("object")), null, 2) : ""}
                height="300px"
                width="500px"
                theme={materialDark}
                extensions={[json()]}
