    ...
    return (
      <React.Fragment>
        ...
        <div className="login-content" style={{margin: this.props.preview ?? this.parseOffset(application.formOffset)}}>
          {Setting.inIframe() || Setting.isMobile() ? null : (<div dangerouslySetInnerHTML={{__html: this.props.themeAlgorithm && this.props.themeAlgorithm.includes("dark") ? application.darkModeFormCss : application.formCss}} />)}
          {Setting.inIframe() || !Setting.isMobile() ? null : (<div dangerouslySetInnerHTML={{__html: this.props.themeAlgorithm && this.props.themeAlgorithm.includes("dark") ? application.darkModeFormCssMobile : application.formCssMobile}} />)}
