        ...
        render: (text, record, index) => {
          return (
            <div>
              ...
              >
                <Button disabled={!Setting.isAdminUser(this.props.account) && (record.owner !== this.props.account.owner)} style={{marginBottom: "10px"}} danger>{i18next.t("general:Delete")}</Button>
              </Popconfirm>
            </div>
          );
        },
