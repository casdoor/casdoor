...
class ProviderListPage extends BaseListPage {
  ...
  fetch = (params = {}) => {
    ...
    (isAdminUser(this.props.account) ? ProviderBackend.getGlobalProviders(params.pagination.current, params.pagination.pageSize, field, value, sortField, sortOrder)
