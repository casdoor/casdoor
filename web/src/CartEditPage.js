    ...
    return (
      <Card size="small" title={
        ...
        <Row style={{marginTop: "10px"}} >
          ...
          <Col span={22} >
            <Select virtual={false} style={{width: "100%"}} disabled={isViewMode} value={this.state.cart.owner} onChange={(value => {
        ...
        <Row style={{marginTop: "20px"}} >
          ...
          <Col span={22} >
            <Input value={this.state.cart.name} disabled={isViewMode} onChange={e => {
        ...
        <Row style={{marginTop: "20px"}} >
          ...
          <Col span={22} >
            <Input value={this.state.cart.displayName} disabled={isViewMode} onChange={e => {
        ...
        <Row style={{marginTop: "20px"}} >
          ...
          <Col span={22} >
            <Select virtual={false} style={{width: "100%"}} disabled={isViewMode} value={this.state.cart.user} onChange={(value => {
        ...
        <Row style={{marginTop: "20px"}} >
          ...
          <Col span={22} >
            <Select virtual={false} style={{width: "100%"}} value={this.state.cart.productName} disabled={isViewMode} onChange={(value => {
        ...
        <Row style={{marginTop: "20px"}} >
          ...
          <Col span={22} >
            <InputNumber min={1} value={this.state.cart.quantity} disabled={isViewMode} onChange={value => {
      ...
      <div>
        ...
        {this.state.mode !== "view" && (
          <div style={{marginTop: "20px", marginLeft: "40px"}}>
            <Button size="large" onClick={() => this.submitCartEdit(false)}>{i18next.t("general:Save")}</Button>
            <Button style={{marginLeft: "20px"}} type="primary" size="large" onClick={() => this.submitCartEdit(true)}>{i18next.t("general:Save & Exit")}</Button>
            {this.state.mode === "add" ? <Button style={{marginLeft: "20px"}} size="large" onClick={() => this.deleteCart()}>{i18next.t("general:Cancel")}</Button> : null}
          </div>
        )}
      </div>
    );
