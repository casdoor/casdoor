...
export function getSessions(owner, page: any = "", pageSize: any = "", field: any = "", value: any = "", sortField: any = "", sortOrder: any = "") {
...
export function deleteSession(session, sessionId: any = "") {
