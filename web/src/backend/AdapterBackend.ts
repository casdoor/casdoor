...
export function getAdapters(owner, page: any = "", pageSize: any = "", field: any = "", value: any = "", sortField: any = "", sortOrder: any = "") {
...
export function getPolicies(owner, name, adapterId: any = "") {
