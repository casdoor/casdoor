...
/** Asks for a one-time sign-in link; the OAuth params ride along so the link can finish the flow. */
...
/** Exchanges a magic link token for a session, a code or a token, as the OAuth params ask. */
