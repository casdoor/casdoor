...
export function getServers(owner, page: any = "", pageSize: any = "", field: any = "", value: any = "", sortField: any = "", sortOrder: any = "") {
...
export function syncMcpTool(owner, name, server, isCleared: any = false) {
  const newServer = Setting.deepCopy(server);
...
export function scanProvider(owner, name, target: any = "") {
