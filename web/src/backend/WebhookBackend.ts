...
export function getWebhooks(owner, organization, page: any = "", pageSize: any = "", field: any = "", value: any = "", sortField: any = "", sortOrder: any = "") {
...
export function getWebhook(owner, name, organization: any = owner) {
