...
export function sendCode(captchaToken, captchaId, method, countryCode = "", dest, type, applicationId, checkUser = "") {
  const formData = new FormData();
...
export function verifyCaptcha(owner, name, captchaToken, captchaId) {
  const formData = new FormData();
