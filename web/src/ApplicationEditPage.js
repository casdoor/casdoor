  ...
  renderApplication() {
    return (
      <Card size="small" title={
        ...
        <Row style={{marginTop: "20px"}} >
          <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 19 : 2}>
            {Setting.getLabel(i18next.t("application:Enable Captcha"), i18next.t("application:Enable Captcha - Tooltip"))} :
          </Col>
          <Col span={1} >
            <Switch checked={this.state.application.enableCaptcha} onChange={checked => {
              this.updateApplicationField("enableCaptcha", checked);
            }} />
          </Col>
        </Row>
        <Row style={{marginTop: "20px"}} >
