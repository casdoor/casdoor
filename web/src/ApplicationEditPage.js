    ...
    return (
      <Card size="small" title={
        ...
        <Row style={{marginTop: "20px"}} >
          ...
          <Col span={22} >
            <InputNumber style={{width: "150px"}} value={this.state.application.cookieExpireInDays} min={1} step={1} precision={0} addonAfter="Days" onChange={value => {
              this.updateApplicationField("cookieExpireInDays", value);
            }} />
          </Col>
        </Row>
        <Row style={{marginTop: "20px"}} >
