      ...
      <Card size="small" title={
        ...
        }
        {
          this.state.syncer.type === "WeCom" ? null : (
            <Row style={{marginTop: "20px"}} >
              <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 22 : 2}>
                {Setting.getLabel(this.state.syncer.type === "Azure AD" || this.state.syncer.type === "Active Directory" ? i18next.t("provider:Tenant ID") : i18next.t("provider:Host"), i18next.t("provider:Host - Tooltip"))} :
              </Col>
              <Col span={22} >
          ...
          <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 22 : 2}>
            {Setting.getLabel(
              this.state.syncer.type === "WeCom" ? i18next.t("provider:Corp ID") :
                this.state.syncer.type === "Azure AD" || this.state.syncer.type === "Active Directory" ? i18next.t("provider:Client ID") :
          ...
          <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 22 : 2}>
            {Setting.getLabel(
              this.state.syncer.type === "WeCom" ? i18next.t("provider:Corp Secret") :
                this.state.syncer.type === "Azure AD" || this.state.syncer.type === "Active Directory" ? i18next.t("provider:Client Secret") :
