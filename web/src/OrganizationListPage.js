  ...
  newOrganization() {
    ...
    return {
      ...
      accountProfileItems: [
        ...
        {name: "Avatar", visible: true},
        {name: "User type", visible: true},
        {name: "Password", visible: true},
        {name: "Email", visible: true},
        {name: "Phone", visible: true},
        {name: "Country/Region", visible: true},
        {name: "Location", visible: true},
        {name: "Title", visible: true},
        {name: "Homepage", visible: true},
        {name: "Bio", visible: true},
        {name: "Tag", visible: true},
        {name: "Signup application", visible: true},
        {name: "3rd-party logins", visible: true},
        {name: "Is admin", visible: true},
        {name: "Is global admin", visible: true},
        {name: "Is forbidden", visible: true},
        {name: "Is deleted", visible: true},
      ],
    }
  }
