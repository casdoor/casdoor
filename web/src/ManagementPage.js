...
import CartEditPage from "./CartEditPage";
  ...
  function renderRouter() {
    ...
    return (
      <Switch>
        ...
        <Route exact path="/carts/:organizationName/:cartName" render={(props) => renderLoginIfNotLoggedIn(<CartEditPage account={account} {...props} />)} />
