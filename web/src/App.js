      ...
      return (
        <div>
          <Switch>
            ...
            <Route exact path="/auto_signup/oauth/authorize" render={(props) => <LoginPage account={this.state.account} type={"code"} mode={"signup"} {...props} onUpdateAccount={(account) => {this.onUpdateAccount(account);}} />} />
