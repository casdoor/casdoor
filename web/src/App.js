...
const OrganizationListPage = loadable(() => import("./OrganizationListPage"));
const OrganizationEditPage = loadable(() => import("./OrganizationEditPage"));
const UserListPage = loadable(() => import("./UserListPage"));
const UserEditPage = loadable(() => import("./UserEditPage"));
const RoleListPage = loadable(() => import("./RoleListPage"));
const RoleEditPage = loadable(() => import("./RoleEditPage"));
const PermissionListPage = loadable(() => import("./PermissionListPage"));
const PermissionEditPage = loadable(() => import("./PermissionEditPage"));
const ProviderListPage = loadable(() => import("./ProviderListPage"));
const ProviderEditPage = loadable(() => import("./ProviderEditPage"));
const ApplicationListPage = loadable(() => import("./ApplicationListPage"));
const ApplicationEditPage = loadable(() => import("./ApplicationEditPage"));
const ResourceListPage = loadable(() => import("./ResourceListPage"));
const LdapEditPage = loadable(() => import("./LdapEditPage"));
const LdapSyncPage = loadable(() => import("./LdapSyncPage"));
const TokenListPage = loadable(() => import("./TokenListPage"));
const TokenEditPage = loadable(() => import("./TokenEditPage"));
const RecordListPage = loadable(() => import("./RecordListPage"));
const WebhookListPage = loadable(() => import("./WebhookListPage"));
const WebhookEditPage = loadable(() => import("./WebhookEditPage"));
const SyncerListPage = loadable(() => import("./SyncerListPage"));
const SyncerEditPage = loadable(() => import("./SyncerEditPage"));
const CertListPage = loadable(() => import("./CertListPage"));
const CertEditPage = loadable(() => import("./CertEditPage"));
const ProductListPage = loadable(() => import("./ProductListPage"));
const ProductEditPage = loadable(() => import("./ProductEditPage"));
const ProductBuyPage = loadable(() => import("./ProductBuyPage"));
const PaymentListPage = loadable(() => import("./PaymentListPage"));
const PaymentEditPage = loadable(() => import("./PaymentEditPage"));
const PaymentResultPage = loadable(() => import("./PaymentResultPage"));
const AccountPage = loadable(() => import("./account/AccountPage"));
const HomePage = loadable(() => import("./basic/HomePage"));
const SignupPage = loadable(() => import("./auth/SignupPage"));
const ResultPage = loadable(() => import("./auth/ResultPage"));
const LoginPage = loadable(() => import("./auth/LoginPage"));
const SelfLoginPage = loadable(() => import("./auth/SelfLoginPage"));
const ForgetPage = loadable(() => import("./auth/ForgetPage"));
const PromptPage = loadable(() => import("./auth/PromptPage"));
const OdicDiscoveryPage = loadable(() => import("./auth/OidcDiscoveryPage"));
const AuthCallback = loadable(() => import("./auth/AuthCallback"));
const SamlCallback = loadable(() => import("./auth/SamlCallback"));
const SelfForgetPage = loadable(() => import("./auth/SelfForgetPage"));
