  ...
  renderRouter() {
    return (
      <Switch>
        ...
        <Route exact path="/organizations/:organizationName/groups/:groupName" render={(props) => this.renderLoginIfNotLoggedIn(<GroupTreePage account={this.state.account} {...props} />)} />
