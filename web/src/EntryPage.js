    ...
    return (
      <div className="loginBackground"
        ...
        <Switch>
          ...
          <Route exact path="/change-password" render={(props) => this.renderLoginIfNotLoggedIn(<ChangePasswordPage {...this.props} application={this.state.application} onUpdateApplication={onUpdateApplication} {...props} />)} />
          <Route exact path="/change-password/:owner" render={(props) => this.renderLoginIfNotLoggedIn(<ChangePasswordPage {...this.props} application={this.state.application} onUpdateApplication={onUpdateApplication} {...props} />)} />
        </Switch>
      </div>
    );
  }
